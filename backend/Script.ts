...
// for(cat of SkillCategory){
//   console.log(cat);
// }
console.log(typeof SkillCategory)

console.log( Object.entries(SkillCategory).length)

// for (let key in ){
//   console.log();
// }
let a = "OTHER";
// Object.entries(SkillCategory).filter((v,i)=>{
//   console.log(v[1], i);
//   if()
...
console.log(Object.values(ob).includes("bac"));